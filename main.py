...
print("Starting...")
Classifier.create_train_and_test_packet(
    "/Users/suenwailun/Sync Documents/University/Y4S1/BT3101 Business Analytics Capstone Project/small data",
    verbose=True,
)
...
for i in range(len(label_data)):
    ...
    if (
        label_data[i] is None
    ):  # check for nonetype class, presents problems in label encoding later
        label_data[i] = "Others"
